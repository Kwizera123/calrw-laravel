			...
			<div class="container">
				...
				<div class="row mb-5">
					<div class="col-lg-5 mx-auto text-center">
						<h2 class="section-title">{{$ourteam->title}}</h2>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
						<img src="{{$ourteam->photo}}" class="img-fluid mb-5">
						<h3 clas><a href="#"><span class="">{{$ourteam->name}}</span></a></h3>
            <span class="d-block position mb-4">{{$ourteam->role}}</span>
