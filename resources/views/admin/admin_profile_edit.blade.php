      ...
      <div class="col-12">
          <div class="card">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <img id="showImage" class="rounded avatar-lg" src="{{ (!empty($editData->profile_image))? url('upload/admin_images/'.$editData->profile_image):url('upload/no_image.jpg') }}" alt="CAL Profile image">   
              </div>
          </div>
          <!-- end row -->
